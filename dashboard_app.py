...
# ---------- FETCH LIVE DATA IF EMPTY ----------
cursor.execute("SELECT COUNT(*) FROM nifty50_raw")
raw_count = cursor.fetchone()[0]

if raw_count == 0:
    st.info("Fetching live Nifty 50 data...")
...
if daily_count == 0:
    ...
    conn.commit()
    st.success("✅ Daily aggregation completed.")
...
if daily_df.empty or latest_df.empty:
    st.info("Data will appear after fetching and aggregating.")
else:
    # Select stock
